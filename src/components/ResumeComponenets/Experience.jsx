...
<div className="w-full md:w-1/2 px-3">
   ...
   <input className="appearance-none block w-full bg-grey-200 text-gray-700 border  rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="number" placeholder="years" />
</div>
</div>
<div className="w-full flex">
<div className="md:w-full px-3">
   ...
   <textarea className="appearance-none block md:w-full bg-grey-200 text-gray-700 border  rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="" />
</div>
</div>
</div>
<hr className='my-4'/>
