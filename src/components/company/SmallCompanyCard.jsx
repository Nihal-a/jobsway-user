...
const SmallCompanyCard = ({company}) => {
    ...
    return (
        <Link to={`/company-details/${company?._id}`} className="w-56 h-64 bg-secondary rounded-md m-3 flex items-center justify-center flex-col p-2 text-center cursor-pointer">
            <img src={company?.logoUrl} alt="" className="h-20 w-20 rounded-md"/>
