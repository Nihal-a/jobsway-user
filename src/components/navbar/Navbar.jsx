      ...
      <div className="flex items-center">
        ...
        <div className="dropdown inline-block relative z-50">
          <button className="bg-gray-300 text-gray-700 font-semibold py-2 px-4 rounded inline-flex items-center">
            <span className="mr-1">Nihal Avulan</span>
          ...
          <ul className="dropdown-menu absolute hidden text-gray-700 pt-1">
            ...
            <li className><a className="hover:bg-black-200 py-3 px-2 block whitespace-no-wrap flex items-center justify-start text-lg text-white" href="#" style={{backgroundColor:"#008FAE"}}><Icon className="mr-1 text-2xl" icon="uil:signout" /><span>Sign Out</span></a></li>
