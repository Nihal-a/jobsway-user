      ...
      <div className="flex items-center">
        ...
        <div className="dropdown inline-block relative z-50">
          ...
          <ul className="dropdown-menu absolute hidden text-gray-700 pt-1">
            <li className><Link to={`/my-profile/${user?.user._id}`} className="bg-gray-200 hover:bg-gray-400 py-3 px-2 block whitespace-no-wrap flex items-center justify-start text-lg w-40" href="#"><Icon className="mr-3 text-2xl" icon="ant-design:profile-outlined" /><span>Profile</span></Link></li>
